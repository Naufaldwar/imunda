...
export const Card = ({ data }) => {
  return (
    <Flex className="relative shadow-lg border w-40 h-40  md:w-80 md:h-80 flex-col rounded-xl p-3 justify-center items-center gap-2 hover:cursor-pointer hover:scale-105">
      ...
      <Image
        src={data.image}
        alt="shadira"
        className="w-auto md:h-48 h-24 object-contain"
      />
